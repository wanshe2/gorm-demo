...
func (p *people) WithContext(ctx context.Context) *peopleDo { return p.peopleDo.WithContext(ctx) }
...
func (p peopleDo) FindMaxVersionCount() (result uint8, err error) {
	var generateSQL strings.Builder
	generateSQL.WriteString("SELECT COUNT(*) FROM users GROUP BY version ORDER BY version DESC LIMIT 1 ")
